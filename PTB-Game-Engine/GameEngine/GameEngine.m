...
methods (Access = public)
    ...
    function obj = Quit(obj)
        ...
        obj.running = false;
        sca;
        assignin('base', 'manual_quit', 0);
    end
    function obj = ManualQuit(obj)
        for i = 1:obj.numObjects
            obj.gameObjects{i}.OnQuit();        end
        fprintf("Game quit.\n");
        obj.running = false;
        sca;
        % I don't like this but itll work %03Nov2020
        assignin('base', 'manual_quit', 1);
    end
